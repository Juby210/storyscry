...
def act_container(act_number, val, height=200):
    ...
    if c3.button("Create scenes", "create " + act_number, use_container_width=True):
        val = utils.create_scenes("Act " + act_number, val)

    text_area_cont.text_area("Act " + act_number, label_visibility="collapsed", height=height, value=val)
